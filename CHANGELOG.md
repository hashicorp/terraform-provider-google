...
NOTES:
* networksecurity: promoted `google_network_security_mirroring_endpoint`, `google_network_security_mirroring_endpoint_group` resources to GA (ga) ([#25988](https://github.com/hashicorp/terraform-provider-google/pull/25988))
DEPRECATIONS:
* backupdr: deprecated redundant `name` field in `google_backupdr_restore_workload`, fixed documentation examples and added more properties to VM test with properties. ([#25986](https://github.com/hashicorp/terraform-provider-google/pull/25986))
* publicca: deprecated `b64url_mac_key` on `google_public_ca_external_account_key`, use `mac_key` instead ([#25964](https://github.com/hashicorp/terraform-provider-google/pull/25964))

IMPROVEMENTS:
* backupdr: promote restore support to GA ([#26013](https://github.com/hashicorp/terraform-provider-google/pull/26013))
* compute: added `network_pass_through_lb_traffic_policy` field to `google_compute_region_backend_service` resource (ga) ([#25994](https://github.com/hashicorp/terraform-provider-google/pull/25994))
* compute: added new values to `policyType` field in `google_compute_network_firewall_policy`, `google_compute_network_firewall_policy_with_rules`, `google_compute_region_network_firewall_policy`, `google_compute_region_network_firewall_policy_with_rules`. ([#25985](https://github.com/hashicorp/terraform-provider-google/pull/25985))
* compute: added support for `network_interface.0.network_attachment` to `google_compute_instance_template` (GA) ([#25995](https://github.com/hashicorp/terraform-provider-google/pull/25995))
* compute: added support for `network_interface.0.network_attachment` to `google_compute_region_instance_template` ([#25995](https://github.com/hashicorp/terraform-provider-google/pull/25995))
* compute: added support for `network_interface.0.vlan` to `google_compute_instance_template`, enabling dynamic NIC ([#25995](https://github.com/hashicorp/terraform-provider-google/pull/25995))
* compute: added support for `network_interface.0.vlan` to `google_compute_instance`, enabling dynamic NIC. Creating and deleting from an existing instance is not yet supported. ([#25995](https://github.com/hashicorp/terraform-provider-google/pull/25995))
* compute: added support for `network_interface.0.vlan` to `google_compute_region_instance_template`, enabling dynamic NIC ([#25995](https://github.com/hashicorp/terraform-provider-google/pull/25995))
...
* run: added `readiness_probe` field to `cloud_run_v2_service` resource ([#26003](https://github.com/hashicorp/terraform-provider-google/pull/26003))
* sql: add missing doc update for database_roles and iam_email ([#25993](https://github.com/hashicorp/terraform-provider-google/pull/25993))
...
BUG FIXES:
* compute: allows to set both ssl_certificates and certificate_map in target_ssl_proxy ([#26012](https://github.com/hashicorp/terraform-provider-google/pull/26012))
