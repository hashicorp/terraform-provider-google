...
* gkehub: added `policyControllerMonitoring` and `mutationEnabled` fields to resource `feature_membership` ([#12265](https://github.com/hashicorp/terraform-provider-google/pull/12265))
