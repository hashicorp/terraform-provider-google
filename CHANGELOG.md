...
* cloudbuild: added `repository_event_config` field to `google_cloudbuild_trigger` resource (ga) ([#15098](https://github.com/hashicorp/terraform-provider-google/pull/15098))
* cloudbuildv2: added `gitlab_config` field to `google_cloudbuildv2_connection` resource (beta) ([#15053](https://github.com/hashicorp/terraform-provider-google/pull/15053))
...
* monitoring: fixed an issue causing `google_monitoring_monitored_project` to appear to be deleted ([#15140](https://github.com/hashicorp/terraform-provider-google/pull/15140))
