...
* saasservicemgmt: updated documentation to reflect the product rebranding from SaaS Runtime to App Lifecycle Manager ([#26880](https://github.com/hashicorp/terraform-provider-google/pull/26880))
* workloadidentity: fixed typo in the healthcare service producer URL in the `google_workload_identity_service_agent` example ([#26937](https://github.com/hashicorp/terraform-provider-google/pull/26937))

FEATURES:
* **New Data Source:** `google_firebase_admin_sdk_config` ([#26901](https://github.com/hashicorp/terraform-provider-google/pull/26901))
* **New Resource:** `google_chronicle_datatable_row` (ga) ([#26960](https://github.com/hashicorp/terraform-provider-google/pull/26960))
* **New Resource:** `google_chronicle_datatable` (ga) ([#26895](https://github.com/hashicorp/terraform-provider-google/pull/26895))
...
* apigee: added support for `consumer_key` and `consumer_secret` fields to `google_apigee_developer_app` resource (revert) ([#26897](https://github.com/hashicorp/terraform-provider-google/pull/26897))
...
* dataform: promoted `google_dataform_folder` to GA ([#26881](https://github.com/hashicorp/terraform-provider-google/pull/26881))
* dataform: promoted `google_dataform_team_folder` to GA ([#26881](https://github.com/hashicorp/terraform-provider-google/pull/26881))
...
* gkehub: added `ignored_clusters_selector` field to `google_gke_hub_rollout_sequence` resource (beta) ([#26926](https://github.com/hashicorp/terraform-provider-google/pull/26926))
...
* netapp: added GA support for largeCapacityConfig field ([#26927](https://github.com/hashicorp/terraform-provider-google/pull/26927))
* netapp: added `kmsConfig`, `encryptionState` and `backupsCryptoKeyVersion` fields to `BackupVault` resource ([#26939](https://github.com/hashicorp/terraform-provider-google/pull/26939))
