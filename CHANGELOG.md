...
* **New Resource:** `google_compute_global_vm_extension_policy` ([#28282](https://github.com/hashicorp/terraform-provider-google/pull/28282))
* **New Resource:** `google_compute_router_named_set` (GA promotion) ([#28326](https://github.com/hashicorp/terraform-provider-google/pull/28326))
* **New Resource:** `google_network_connectivity_custom_hardware_instance` (revert, cherrypicked 7.40.0) ([#28312](https://github.com/hashicorp/terraform-provider-google/pull/28312))
* **New Resource:** chronicle: `google_chronicle_environment_group` (GA) ([#28338](https://github.com/hashicorp/terraform-provider-google/pull/28338))
...
* compute: added `FLEX_START` and `RESERVATION_BOUND` support to `google_compute_instance`, `google_compute_instance_template`, and `google_compute_region_instance_template` resource ([#28365](https://github.com/hashicorp/terraform-provider-google/pull/28365))
...
* dataform: added `git_repository_link` field to `google_dataform_repository` resource (beta) ([#28313](https://github.com/hashicorp/terraform-provider-google/pull/28313))
...
* dataproc: added the `instance_selection.disk_config` field to the `google_dataproc_cluster` resource ([#28339](https://github.com/hashicorp/terraform-provider-google/pull/28339))
...
* google_sql_database_instance: Added `instance_auto_dns_status` and `write_endpoint_auto_dns_status` output fields to the `psc_auto_connections` block in `google_sql_database_instance` resource ([#28331](https://github.com/hashicorp/terraform-provider-google/pull/28331))
...
* workebench: added `enable_deletion_protection` field to `google_workbench_instance` resource ([#28355](https://github.com/hashicorp/terraform-provider-google/pull/28355))
