...
* Add support for Apigee Sharedflow ([#13938](https://github.com/hashicorp/terraform-provider-google/pull/13938))
...
* privateca: added support for X.509 name constraints ([#13969](https://github.com/hashicorp/terraform-provider-google/pull/13969))

BUG FIXES:
* alloydb: fix permadiff on `automated_backup_policy.weekly_schedule` of `google_alloydb_cluster` ([#13948](https://github.com/hashicorp/terraform-provider-google/pull/13948))
