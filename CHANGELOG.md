...
* Added go:build tools line ([#10178](https://github.com/hashicorp/terraform-provider-google/pull/10178))
* Added monitoring metrics scope and monitored project resources. ([#10126](https://github.com/hashicorp/terraform-provider-google/pull/10126))
* Revert "Added monitoring metrics scope and monitored project resource… ([#10139](https://github.com/hashicorp/terraform-provider-google/pull/10139))
DEPRECATIONS:
...
* compute: Fixed recreation of GCE instances when updating `resource_policies` property ([#10173](https://github.com/hashicorp/terraform-provider-google/pull/10173))
* compute: added NetLB support for Connection Tracking as `connectionTrackingPolicy` in `RegionBackendService` ([#10150](https://github.com/hashicorp/terraform-provider-google/pull/10150))
...
* filestore: fixed `reserved_ip_range` can't be updated on `google_filestore_instance` ([#10146](https://github.com/hashicorp/terraform-provider-google/pull/10146))
