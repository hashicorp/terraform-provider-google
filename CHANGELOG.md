...
* compute: adding `labels` field to resource_compute_interconnect_attachment ([#20971](https://github.com/hashicorp/terraform-provider-google/pull/20971))
...
* gemini: promoted resources `gemini_code_repository_index`, `gemini_repository_group` to GA. ([#20941](https://github.com/hashicorp/terraform-provider-google/pull/20941))
