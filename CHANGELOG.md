...
* google_composer_environment: added support for creation and update for config.software_config.web_server_plugins_mode and config.workloads_config. dag_processor fields. ([#16887](https://github.com/hashicorp/terraform-provider-google/pull/16887))
...
* containerattached: fixed crash when updating a cluster to remove `admin_users` or `admin_groups` ([#16852](https://github.com/hashicorp/terraform-provider-google/pull/16852))
