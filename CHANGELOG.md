...
* provider: made data sources return errors on 404s when applicable instead of silently failing ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* provider: made empty strings in the provider configuration block no longer be ignored when configuring the provider([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* cloudiot: removed deprecated datasource `google_cloudiot_registry_iam_policy` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* cloudiot: removed deprecated resource `google_cloudiot_device` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* cloudiot: removed deprecated resource  `google_cloudiot_registry` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* cloudiot: removed deprecated resource `google_cloudiot_registry_iam_*` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* compute: made `google_compute_node_group` require one of `initial_size` or `autoscaling_policy` fields configured upon resource creation ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* compute: made `size` in `google_compute_node_group` an output only field. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* container: added `deletion_protection` to `google_container_cluster` which is enabled to `true` by default. When enabled, this field prevents Terraform from deleting the resource. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* gameservices: removed Terraform support for `gameservices` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* baremetal: made delete a noop for the resource `google_bare_metal_admin_cluster` to better align with actual behavior ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* bigquery: fixed diff suppression in `external_data_configuration.connection_id` ([#15983](https://github.com/hashicorp/terraform-provider-google/pull/15983))
