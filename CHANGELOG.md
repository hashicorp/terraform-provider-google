...
* compute: added support for `network_interface.network_attachment` to `google_compute_instance_template` (GA) ([#25995](https://github.com/hashicorp/terraform-provider-google/pull/25995))
...
* firestore: add `firestore_data_access_mode`, `mongodb_compatible_data_acess_mode`, and `realtime_updates_mode` fields to the `google_firestore_database` resource ([#26000](https://github.com/hashicorp/terraform-provider-google/pull/26000))
...
* monitoring: add write-only variants (`auth_token_wo` + `auth_token_wo_version`, `password_wo` + `password_wo_version`, `service_key_wo` + `service_key_wo_version`) for `google_monitoring_notification_channel.sensitive_labels` ([#25983](https://github.com/hashicorp/terraform-provider-google/pull/25983))
