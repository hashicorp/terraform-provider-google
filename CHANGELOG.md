...
* `google_compute_address` ([#27917](https://github.com/hashicorp/terraform-provider-google/pull/27917))
* `google_compute_cross_site_network` ([#27864](https://github.com/hashicorp/terraform-provider-google/pull/27864))
* `google_compute_https_health_check` ([#27917](https://github.com/hashicorp/terraform-provider-google/pull/27917))
* `google_compute_node_template` ([#27917](https://github.com/hashicorp/terraform-provider-google/pull/27917))
* `google_compute_packet_mirroring` ([#27917](https://github.com/hashicorp/terraform-provider-google/pull/27917))
* `google_compute_region_autoscaler` ([#27917](https://github.com/hashicorp/terraform-provider-google/pull/27917))
* `google_compute_region_composite_health_check` ([#27917](https://github.com/hashicorp/terraform-provider-google/pull/27917))
* `google_compute_region_health_aggregation_policy` ([#27917](https://github.com/hashicorp/terraform-provider-google/pull/27917))
* `google_compute_region_health_source` ([#27917](https://github.com/hashicorp/terraform-provider-google/pull/27917))
* `google_project_iam_member` ([#27905](https://github.com/hashicorp/terraform-provider-google/pull/27905))
* `google_pubsub_topic` ([#27914](https://github.com/hashicorp/terraform-provider-google/pull/27914))
* `google_secret_manager_secret` ([#27910](https://github.com/hashicorp/terraform-provider-google/pull/27910))
