...
NOTES:
* (revert) cloudfunctions2: added new fields `direct_vpc_network_interface` and `direct_vpc_egress`. Users who have enabled DirectVPC on the underlying Run service will need to take extra care, as the values may now need to be explicitly set in your configuration ([#26091](https://github.com/hashicorp/terraform-provider-google/pull/26091))
* (revert) cloudfunctions2: promoted `direct_vpc_network_interface` and `direct_vpc_egress` fields to GA in the `google_cloudfunctions2_function` resource. ([#26091](https://github.com/hashicorp/terraform-provider-google/pull/26091))
...
BREAKING CHANGES:
* cloudfunctions2: added new fields `direct_vpc_network_interface` and `direct_vpc_egress`. Users who have enabled DirectVPC on the underlying Run service will need to take extra care, as the values may now need to be explicitly set in your configuration ([#26079](https://github.com/hashicorp/terraform-provider-google/pull/26079))
...
* **New Data Source:** `google_kms_secret_asymmetric` (ga) ([#26096](https://github.com/hashicorp/terraform-provider-google/pull/26096))
...
* cloudfunctions2: promoted `direct_vpc_network_interface` and `direct_vpc_egress` fields to GA in the `google_cloudfunctions2_function` resource. ([#26079](https://github.com/hashicorp/terraform-provider-google/pull/26079))
...
* filestore: added `replica_action` to `google_filestore_instance` ([#26082](https://github.com/hashicorp/terraform-provider-google/pull/26082))
* networksecurity: added `policy_profile`, `http_rules.0.to.0.operations.0.mcp` to `google_network_security_authz_policy`. Relaxed `load_balancing_scheme` validation to support non-Backend Service targets. ([#26090](https://github.com/hashicorp/terraform-provider-google/pull/26090))
...
* sql: added `server_certificate_rotation_mode` field to `google_sql_database_instance` resource (revert) ([#26100](https://github.com/hashicorp/terraform-provider-google/pull/26100))
...
* ces: fixed callback function definitions and invalid models in agent tests ([#26077](https://github.com/hashicorp/terraform-provider-google/pull/26077))
...
* publicca: fixed `mac_key` not set in `google_public_ca_external_account_key` ([#26099](https://github.com/hashicorp/terraform-provider-google/pull/26099))
