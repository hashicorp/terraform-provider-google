...
* containerazure: added `image_type` to `google_container_azure_node_pool` resource (beta) ([#11635](https://github.com/hashicorp/terraform-provider-google/pull/11635))
* containerazure: added `logging_config` to `google_container_azure_cluster` resource (beta) ([#11635](https://github.com/hashicorp/terraform-provider-google/pull/11635))
