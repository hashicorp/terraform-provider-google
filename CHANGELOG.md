...
* feat(vertexai): Add IAM resources for Vertex AI FeatureStore EntityType (beta) ([#13126](https://github.com/hashicorp/terraform-provider-google/pull/13126))
...
* **New Resource:** `google_iam_workforce_pool_provider` ([#13130](https://github.com/hashicorp/terraform-provider-google/pull/13130))
...
IMPROVEMENTS:
* anthos-fleet-management: added option `mesh: control_plane` to resource `google_gke_hub_feature_membership`. ([#13135](https://github.com/hashicorp/terraform-provider-google/pull/13135))
...
* datafusion: add `api_endpoint` and `p4_service_account ` attributes to `google_data_fusion_instance` ([#13134](https://github.com/hashicorp/terraform-provider-google/pull/13134))
* datafusion: add `zone`, `display_name`, `crypto_key_config`, `event_publish_config`, and `enable_rbac` args to `google_data_fusion_instance` ([#13134](https://github.com/hashicorp/terraform-provider-google/pull/13134))
...
* container: fixed unable to update `authenticator_groups_config` on `google_container_cluster` ([#13111](https://github.com/hashicorp/terraform-provider-google/pull/13111))
* container: throw exception if the data source `google_container_cluster` does not exist ([#13070](https://github.com/hashicorp/terraform-provider-google/pull/13070))
* sql: fix `googe_sql_database_instance` to include `backup_configuration` in initial create request ([#13092](https://github.com/hashicorp/terraform-provider-google/pull/13092))
