...
* **New Resource:** `google_vector_search_collection` (ga) ([#26353](https://github.com/hashicorp/terraform-provider-google/pull/26353))
...
* compute: added `params` field to `google_compute_external_vpn_gateway` resource (ga) ([#26348](https://github.com/hashicorp/terraform-provider-google/pull/26348))
* compute: added `params` field to `google_compute_ha_vpn_gateway` resource (ga) ([#26348](https://github.com/hashicorp/terraform-provider-google/pull/26348))
* compute: added `params` field to `google_compute_vpn_gateway` resource (ga) ([#26348](https://github.com/hashicorp/terraform-provider-google/pull/26348))
* compute: added `params` field to `google_compute_vpn_tunnel` resource (ga) ([#26348](https://github.com/hashicorp/terraform-provider-google/pull/26348))
