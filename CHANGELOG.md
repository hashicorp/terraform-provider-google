...
* networkconnectivity: added `IPV6` enum to `protocolVersion` field in `PolicyBasedRoute` resource ([#23069](https://github.com/hashicorp/terraform-provider-google/pull/23069))
