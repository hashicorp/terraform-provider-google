...
* dataproc: added support for `SPOT` option for `preemptibility` in `google_dataproc_cluster` ([#13231](https://github.com/hashicorp/terraform-provider-google/pull/13231))
* dataproc: added support for `dataproc_metric_config` in `google_dataproc_cluster` ([#13231](https://github.com/hashicorp/terraform-provider-google/pull/13231))
