## 3.25.0 (Unreleased)
FEATURES:
* **New Resource:** `data_catalog_tag_template` ([#6485](https://github.com/terraform-providers/terraform-provider-google/pull/6485))
...
IMPROVEMENTS:
* appengine: add `inbound_services` to `StandardAppVersion` resource ([#6514](https://github.com/terraform-providers/terraform-provider-google/pull/6514))
