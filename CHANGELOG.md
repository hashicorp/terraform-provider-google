...
* bigquery: added `external_runtime_options` and `python_options` fields to `bigquery_routine` resource (beta) ([#25293](https://github.com/hashicorp/terraform-provider-google/pull/25293))
...
* filestore: add support for updating `directory_services` fields in place in `google_filestore_instance` ([#25315](https://github.com/hashicorp/terraform-provider-google/pull/25315))
...
* netapp: Add public docs link for `google_netapp_host_group` resource ([#25368](https://github.com/hashicorp/terraform-provider-google/pull/25368))
...
* networksecurity: added field `custom_mirroring_profile.mirroring_deployment_groups` and output field `custom_mirroring_profile.mirroring_endpoint_group_type` to `google_network_security_security_profile` resource (beta) ([#25249](https://github.com/hashicorp/terraform-provider-google/pull/25249))
...
* spanner: prevented forceNew when kmsKeyName and kmsKeyNames are same for `google_spanner_database` ([#25215](https://github.com/hashicorp/terraform-provider-google/pull/25215))
