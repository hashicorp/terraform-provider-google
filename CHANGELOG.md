...
* Bridge gap between Terraform and API for AlloyDB ([#15974](https://github.com/hashicorp/terraform-provider-google/pull/15974))
* Update CHANGELOG.md for v4.84.0 ([#16002](https://github.com/hashicorp/terraform-provider-google/pull/16002))
* add support for inter-VPC communications in router_nat resource ([#15987](https://github.com/hashicorp/terraform-provider-google/pull/15987))
NOTES:
* compute: `google_compute_node_group` made to require one of `initial_size` or `autoscaling_policy` fields configured upon resource creation ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* provider: some provider default values are now shown at plan-time ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
DEPRECATIONS:
* cloudiot:  deprecated datasource `google_cloudiot_registry_iam_policy` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* cloudiot:  deprecated resource `google_cloudiot_device` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* cloudiot: deprecated resource  `google_cloudiot_registry` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* cloudiot: deprecated resource `google_cloudiot_registry_iam_*` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* privateca: removed deprecated fields `configValues`, `pemCertificates` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
BREAKING CHANGES:
* accesscontextmanager: changed multiple array fields to sets where appropriate to prevent duplicates and fix diffs caused by server side reordering. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* bigquery: added more input validations for BigQuery table schema ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* bigquery: made `routine_type` required for `google_bigquery_routine` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* cloudfunction2: made `location` required on `google_cloudfunctions2_function` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* cloudrunv2: Removed deprecated field `liveness_probe.tcp_socket` from `google_cloud_run_v2_service` resource. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* cloudrunv2: Removed deprecated fields `startup_probe` and `liveness_probe` from `google_cloud_run_v2_job` resource. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* cloudrunv2: transitioned `volumes.cloud_sql_instance.instances` to SET from ARRAY for `google_cloud_run_v2_service` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* compute: `size` in `google_compute_node_group` is now an output only field. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* compute: removed default value for `rule.rate_limit_options.encorce_on_key` on resource `google_compute_security_policy` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* compute: retyped `consumer_accept_lists` to a SET from an ARRAY type for `google_compute_service_attachment ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* container: `google_container_cluster` now has `deletion_protection` enabled to `true` by default. When enabled, this field prevents Terraform from deleting the resource. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* container: changed `management.auto_repair` and `management.auto_upgrade` defaults to true in `google_container_node_pool` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* container: removed `enable_binary_authorization` in `google_container_cluster` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* container: removed default for `logging_variant` in `google_container_node_pool` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* container: removed default value in `network_policy.provider` in `google_container_cluster` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* container: removed the behaviour that `google_container_cluster` will delete the cluster if it's created in an error state. Instead, it will mark the cluster as tainted, allowing manual inspection and intervention. To proceed with deletion, run another `terraform apply`. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* container: reworked the `taint` field in `google_container_cluster` and `google_container_node_pool` to only manage a subset of taint keys based on those already in state. Most existing resources are unaffected, unless they use `sandbox_config`- see upgrade guide for details. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* dataplex: removed `data_profile_result` and `data_quality_result` from `google_dataplex_scan` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* firebase: changed `deletion_policy` default to `DELETE` for `google_firebase_web_app`. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* firebase: made `google_firebase_rules.release` immutable ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* firebase: removed `google_firebase_project_location` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* gameservices: Remove Terraform support for `gameservices` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* logging: changed the default value of `unique_writer_identity` from `false` to `true` in `google_logging_project_sink`. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* logging: made `growth_factor`, `num_finite_buckets`, and `scale` required for `google_logging_metric` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* looker: removed `LOOKER_MODELER` as a possible value in `google_looker_instance. platform_edition` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* monitoring: fixed perma-diffs in `google_monitoring_dashboard.dashboard_json` by suppressing values returned by the API that are not in configuration ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* monitoring: made `labels` immutable in `google_monitoring_metric_descriptor` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* provider: Empty strings in the provider configuration block will no longer be ignored when configuring the provider ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* provider: added provider-level validation so these fields are not set as empty strings in a user's config: `credentials`, `access_token`, `impersonate_service_account`, `project`, `billing_project`, `region`, `zone` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* provider: data sources now return errors on 404s when applicable instead of silently failing ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* provider: fixed many import functions throughout the provider that matched a subset of the provided input when possible. Now, the GCP resource id supplied to "terraform import" must match exactly. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* secretmanager: removed `automatic` field in `google_secret_manager_secret` resource ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* servicenetworking: used Create instead of Patch to create `google_service_networking_connection` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* servicenetworking: used the `deleteConnection` method to delete the resource `google_service_networking_connection` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* baremetal: make delete a noop for the resource `google_bare_metal_admin_cluster` to better align with actual behavior ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* compute: `google_compute_node_group` made mutable ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* compute: added `network_interface.security_policy` field to `google_compute_instance` resource (beta) ([#15949](https://github.com/hashicorp/terraform-provider-google/pull/15949))
* container: added the `effective_taints` attribute to `google_container_cluster` and `google_container_node_pool`, outputting all known taint values ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* container: allow setting `addons_config.gcs_fuse_csi_driver_config` on `google_container_cluster` with `enable_autopilot: true`. ([#15996](https://github.com/hashicorp/terraform-provider-google/pull/15996))
* containeraws: added `binary_authorization` to `google_container_aws_cluster` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* containeraws: added `update_settings` to `google_container_aws_node_pool` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* provider: added provider default labels ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* workstations: added `replica_zones`, `service_account_scopes`, and `enable_audit_agent` to `google_workstations_workstation_config` (beta) ([#15964](https://github.com/hashicorp/terraform-provider-google/pull/15964))

BUG FIXES:
* `dataflow`: fixed issue causing error message when max_workers and num_workers were supplied via parameters. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* `dataflow`: fixed max_workers read value permanently displaying as 0. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* `dataflow`: fixed permadiff when SdkPipeline values are supplied via parameters. ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* bigquery: fix diff suppression in `external_data_configuration.connection_id` ([#15983](https://github.com/hashicorp/terraform-provider-google/pull/15983))
* bigquery: fixed view and materialized view creation when schema is specified ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* bigtable: avoided re-creation of instance when cluster is still updating and storage type changed ([#15961](https://github.com/hashicorp/terraform-provider-google/pull/15961))
...
* compute: added default value to `metric.filter` in the resource `google_compute_autoscaler` (beta) ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* compute: removed the default value for field `reconcile_connections ` in resource `google_compute_service_attachment`, the field will now default to a value returned by the API when not set in configuration ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
* compute: used APIs default value for field `enable_endpoint_independent_mapping` in resource `google_compute_router_nat` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* monitoring: fixed an issue where `metadata` was not able to be updated in `google_monitoring_metric_descriptor` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* provider: fixed a bug where labels/annotations field not exists in GA for some resources ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
...
* sql: fixed diffs when re-ordering existing `database_flags` ([#16034](https://github.com/hashicorp/terraform-provider-google/pull/16034))
