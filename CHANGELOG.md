...
* cloudfunctions: `google_cloudfunctions_function` no longer restricts an outdated list of `region`s ([#3530](https://github.com/terraform-providers/terraform-provider-google/issues/3530))
...
* dns: `google_dns_managed_zone` does not permadiff when visibility is set to default and returned as empty from API ([#3459](https://github.com/terraform-providers/terraform-provider-google/issues/3461))
...
* cloudfunctions: ` google_cloudfunctions_function` now has source repo support ([#2650](https://github.com/terraform-providers/terraform-provider-google/issues/2650))
...
* compute: fix disk behaviour in compute_instance_from_template ([#2695](https://github.com/terraform-providers/terraform-provider-google/issues/2695))
