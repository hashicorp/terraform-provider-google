...
* **New Resource:** pubsub: added GCS ingestion settings and platform log settings to `google_pubsub_topic` resource ([#19669](https://github.com/hashicorp/terraform-provider-google/pull/19669))
...
* compute: move `TDX` instance option for `confidential_instance_type` in `google_compute_instance` from Beta to GA(ga) ([#19706](https://github.com/hashicorp/terraform-provider-google/pull/19706))
* compute: promoted `client_destination_port` and `instance` fields in `google_compute_region_network_endpoint` resource to GA (revert) ([#19684](https://github.com/hashicorp/terraform-provider-google/pull/19684))
...
* dataproc: switched to the v1 API for `google_dataproc_autoscaling_policy` resource (beta) ([#19686](https://github.com/hashicorp/terraform-provider-google/pull/19686))
