...
* gkeonprem: added `private_registry_config` field to `google_gkeonprem_vmware_admin_cluster` resource (beta) ([#23182](https://github.com/hashicorp/terraform-provider-google/pull/23182))
