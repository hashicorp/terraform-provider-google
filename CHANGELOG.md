...
* compute: promoted `visible_core_count` field of `google_compute_instance` to GA ([#13043](https://github.com/hashicorp/terraform-provider-google/pull/13043))
...
* cloudbuild: fixed the failure when BITBUCKET is provided for `repo_type` on `google_cloudbuild_trigger` ([#13027](https://github.com/hashicorp/terraform-provider-google/pull/13027))
