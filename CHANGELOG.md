...
* bigquery: added more input validations for BigQuery table schema ([#15338](https://github.com/hashicorp/terraform-provider-google/pull/15338))
...
* privateca: removed deprecated fields `configValues`, `pemCertificates` ([#15537](https://github.com/hashicorp/terraform-provider-google/pull/15537))
...
IMPROVEMENTS:
* provider: added provider default labels ([#15740](https://github.com/hashicorp/terraform-provider-google/pull/15740))
...
BUG FIXES:
* dataflow: fixed issue causing error message when max_workers and num_workers were supplied via parameters. ([#15976](https://github.com/hashicorp/terraform-provider-google/pull/15976))
* dataflow: fixed max_workers read value permanently displaying as 0. ([#15976](https://github.com/hashicorp/terraform-provider-google/pull/15976))
* dataflow: fixed permadiff when SdkPipeline values are supplied via parameters. ([#15976](https://github.com/hashicorp/terraform-provider-google/pull/15976))
...
* bigquery: fixed view and materialized view creation when schema is specified ([#15442](https://github.com/hashicorp/terraform-provider-google/pull/15442))
...
* compute: used APIs default value for field `enable_endpoint_independent_mapping` in resource `google_compute_router_nat` ([#15478](https://github.com/hashicorp/terraform-provider-google/pull/15478))
...
* sql: fixed diffs when re-ordering existing `database_flags` ([#15678](https://github.com/hashicorp/terraform-provider-google/pull/15678))
