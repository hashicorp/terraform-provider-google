...
IMPROVEMENTS:
* compute: added update support for field `enable_proxy_protocol` in `google_compute_service_attachment` resource ([#15716](https://github.com/hashicorp/terraform-provider-google/pull/15716))
* compute: added update support for field `reconcile_connections` in `google_compute_service_attachment` resource ([#15706](https://github.com/hashicorp/terraform-provider-google/pull/15706))
* compute: added update support for field `allowPscGlobalAccess` in `google_compute_forwarding_rule` resource ([#15691](https://github.com/hashicorp/terraform-provider-google/pull/15691))
...
* secretmanager: added in-place update support for field `replication.user_managed.replicas.customer_managed_encryption` field in `google_secret_manager_secret` resource ([#15685](https://github.com/hashicorp/terraform-provider-google/pull/15685))

BUG FIXES:
* bigquery: fixed an error from updating immutable `params` of `google_bigquery_data_transfer_config` ([#15723](https://github.com/hashicorp/terraform-provider-google/pull/15723))
* dns: fixed hash function for `network_url` in `google_dns_managed_zone` and `google_dns_policy` resources ([#15728](https://github.com/hashicorp/terraform-provider-google/pull/15728))
