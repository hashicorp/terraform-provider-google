...
* compute: added `server_tls_policy` argument to `target_https_proxy` resource ([#15845](https://github.com/hashicorp/terraform-provider-google/pull/15845))
...
* container: promoted `node_pool_auto_config` field in `google_container_cluster` from beta provider to GA provider. (ga) ([#15884](https://github.com/hashicorp/terraform-provider-google/pull/15884))
...
* containeraws: added support for `auto_repair` in `container_aws_node_pool` ([#15862](https://github.com/hashicorp/terraform-provider-google/pull/15862))
* containerazure: added support for `auto_repair` in `container_azure_node_pool` ([#15862](https://github.com/hashicorp/terraform-provider-google/pull/15862))
...
* networkconnectivity: added support for `linked_vpc_network` in `network_connectivity_spoke` ([#15862](https://github.com/hashicorp/terraform-provider-google/pull/15862))
...
BUG FIXES:
* bigquery: update documentation for `google_bigquery_table.time_partitioning.expiration_ms` ([#15873](https://github.com/hashicorp/terraform-provider-google/pull/15873))
...
* eventarc: field `event_data_content_type` in `eventarc_trigger` now marked as computed ([#15862](https://github.com/hashicorp/terraform-provider-google/pull/15862))
