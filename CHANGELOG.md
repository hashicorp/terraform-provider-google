...
* netapp: added `default_from_api = true` attribute to `smb_settings` field of GoogleCloudNetappVolumes ([#18790](https://github.com/hashicorp/terraform-provider-google/pull/18790))
...
* vmwareengine: support type change from `TIME_LIMITED` to `STANDARD` for multi-node `google_vmwareengine_private_cloud` resource ([#18698](https://github.com/hashicorp/terraform-provider-google/pull/18698))
* workbench: Changed `instance_owners` field in the examples to not use a service account. ([#18802](https://github.com/hashicorp/terraform-provider-google/pull/18802))
...
* firestore: fixed bug where fields `database`, `collection`, `document_id`, and `field` on resources could not be updated. ([#18821](https://github.com/hashicorp/terraform-provider-google/pull/18821))
