...
* Revert "feat(vertexai): add google_vertex_ai_online_evaluator resource" (#18084) (#28162) ([#28163](https://github.com/hashicorp/terraform-provider-google/pull/28163))
NOTES:
* The `google_vertex_ai_online_evaluator` resource has been reverted. ([#28162](https://github.com/hashicorp/terraform-provider-google/pull/28162))
* compute: Migrate `expandAdvancedMachineFeatures`, `flattenAdvancedMachineFeatures` functions in `compute_instance_helpers.go.tmpl` to use direct HTTP rather than a client library ([#28160](https://github.com/hashicorp/terraform-provider-google/pull/28160))
...
* **New Resource:** `google_bigquery_analytics_hub_query_template` (beta) ([#28265](https://github.com/hashicorp/terraform-provider-google/pull/28265))
* **New Resource:** `google_chronicle_environment_group` (beta) ([#28198](https://github.com/hashicorp/terraform-provider-google/pull/28198))
* **New Resource:** `google_chronicle_findings_refinement_deployment` (ga) ([#28240](https://github.com/hashicorp/terraform-provider-google/pull/28240))
...
* **New Resource:** `google_vertex_ai_semantic_governance_policy_engine` (beta) ([#28193](https://github.com/hashicorp/terraform-provider-google/pull/28193))
* **New Resource:** chronicle: `google_chronicle_environment` (GA) ([#28206](https://github.com/hashicorp/terraform-provider-google/pull/28206))
* **New Resource:** chronicle: added `google_chronicle_data_export` resource - GA ([#28239](https://github.com/hashicorp/terraform-provider-google/pull/28239))
...
* cloudscheudler: added retries for the Cloud Scheduler "409: sync mutate calls cannot be queued" error on Scheduler's Job resource mutations. ([#28164](https://github.com/hashicorp/terraform-provider-google/pull/28164))
* compute: added `send_empty_value` field to `enableProxyProtocol` on `ServiceAttachment` resource ([#28264](https://github.com/hashicorp/terraform-provider-google/pull/28264))
...
* compute: added `workload_identity_config` fields to `resource_compute_instance` and `resource_compute_instance_template` resources ([#28266](https://github.com/hashicorp/terraform-provider-google/pull/28266))
* compute: promote `instance_lifecycle_policy.on_repair.allow_changing_zone` to  ga. ([#28174](https://github.com/hashicorp/terraform-provider-google/pull/28174))
...
* sql: added `enforce_new_sql_network_architecture` field to `google_sql_database_instance` resource (create-only) ([#28233](https://github.com/hashicorp/terraform-provider-google/pull/28233))
...
* storage: depercated `admin-on-second-miss` in `google_storage_anywhere_cache` ([#28210](https://github.com/hashicorp/terraform-provider-google/pull/28210))
...
* vertex_ai: added `customization_configs` and `structured_memory_configs` fields to `google_vertex_ai_reasoning_engine` resource ([#28179](https://github.com/hashicorp/terraform-provider-google/pull/28179))
* vertexai: added `traffic_config`, `url`, `agent_server_mode`, `agent_gateway_config`, `keep_alive_probe`, `dedicated_ingress_endpoint_enabled`, `agent_config_source`, `agent_card`, `example_store`, `build_spec`, `traffic_config`, and `example_store_config` fields to `google_vertex_ai_reasoning_engine` (beta) ([#28267](https://github.com/hashicorp/terraform-provider-google/pull/28267))
