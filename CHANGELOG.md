...
* compute: fixed service account scope alias to be updated. ([#10377](https://github.com/hashicorp/terraform-provider-google/pull/10377))
...
* container: `instance_group_urls` has been removed in favor of `node_pool.instance_group_urls` ([#10442](https://github.com/hashicorp/terraform-provider-google/pull/10442))
...
* resourcemanager: `org_id`, `folder_id` are unset when removed from config in `google_project` ([#10373](https://github.com/hashicorp/terraform-provider-google/pull/10373))
