...
* monitoring: made it required to set exactly one of `http_check.auth_info.password` and `http_check.auth_info.password_wo` in google_monitoring_uptime_check_config [#24083](https://github.com/hashicorp/terraform-provider-google/pull/24083)
...
* secretmanager: made `secret_data_wo` and `secret_data_wo_version` both required when one is set in `google_secret_manager_secret_version` [#24083](https://github.com/hashicorp/terraform-provider-google/pull/24083)
...
* secretmanager: reverted breaking type and default value changes for secret manager ([#24061](https://github.com/hashicorp/terraform-provider-google/pull/24061))
