...
func testSweepVertexAIIndexEndpoint(region string) error {
	...
	listTemplate := strings.Split("https://{{region}}-aiplatform.googleapis.com/v1/projects/{{project}}/locations/{{region}}/indexEndpoints", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://{{region}}-aiplatform.googleapis.com/v1/projects/{{project}}/locations/{{region}}/indexEndpoints/{{name}}"
