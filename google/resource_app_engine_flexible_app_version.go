				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"auth_fail_action": {
							...
							Description:  `Action to take when users access resources that require authentication. Defaults to "AUTH_FAIL_ACTION_REDIRECT".`,
						...
						"login": {
							...
							Description:  `Level of login required to access this resource. Defaults to "LOGIN_OPTIONAL".`,
...
the configuration ID. In this case, configId must be omitted.`,
						...
						"rollout_strategy": {
							...
							Description:  `Endpoints rollout strategy. If FIXED, configId must be specified. If MANAGED, configId must be omitted. Default is "FIXED".`,
							Default:      "FIXED",
						},
					},
				},
...
Please see the app.yaml reference for valid values at https://cloud.google.com/appengine/docs/standard//config/appref`,
			...
			"serving_status": {
				...
				Description: `Current serving status of this version. Only the versions with a SERVING status create instances and can be billed.
Defaults to SERVING.`,
				Default: "SERVING",
			},
			"version_id": {
