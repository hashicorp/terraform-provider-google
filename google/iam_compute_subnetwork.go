...
func resourceManagerToComputeBetaPolicy(p *cloudresourcemanager.Policy) (*compute.Policy, error) {
	out := &compute.Policy{}
	err := Convert(p, out)
	if err != nil {
...
func computeBetaToResourceManagerPolicy(p *compute.Policy) (*cloudresourcemanager.Policy, error) {
