...
func TestAccVertexAIEndpoint_vertexAiEndpointNetworkExample(t *testing.T) {
	t.Parallel()
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVertexAIEndpoint_vertexAiEndpointNetworkExample(context),
			},
			{
...
func testAccVertexAIEndpoint_vertexAiEndpointNetworkExample(context map[string]interface{}) string {
	return Nprintf(`
