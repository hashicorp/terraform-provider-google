...
func testSweepSpannerInstance(region string) error {
	...
	listTemplate := strings.Split("https://spanner.googleapis.com/v1/projects/{{project}}/instances", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://spanner.googleapis.com/v1/projects/{{project}}/instances/{{name}}"
