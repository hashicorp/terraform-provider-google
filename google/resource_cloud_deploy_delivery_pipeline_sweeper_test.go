...
func testSweepCloudDeployDeliveryPipeline(region string) error {
	resourceName := "CloudDeployDeliveryPipeline"
	...
	listTemplate := strings.Split("https://clouddeploy.googleapis.com/v1/projects/{{project}}/locations/{{region}}/deliveryPipelines", "?")[0]
	...
	resourceList, ok := res["deliveryPipelines"]
	if !ok {
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://clouddeploy.googleapis.com/v1/projects/{{project}}/locations/{{region}}/deliveryPipelines/{{name}}"
