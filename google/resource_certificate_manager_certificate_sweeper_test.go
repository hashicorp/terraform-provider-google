...
func testSweepCertificateManagerCertificate(region string) error {
	...
	listTemplate := strings.Split("https://certificatemanager.googleapis.com/v1alpha2/projects/{{project}}/locations/global/certificates", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://certificatemanager.googleapis.com/v1alpha2/projects/{{project}}/locations/global/certificates/{{name}}"
