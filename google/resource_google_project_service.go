...
// removals, if we fail to create a service that's been renamed we'll attempt to
// create it with the other name. If both fail, we return the original error.
...
var renamedServices = map[string]string{
	...
	"compute2.googleapis.com":      "compute.googleapis.com",
}
