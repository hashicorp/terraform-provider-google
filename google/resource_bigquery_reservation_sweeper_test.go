...
func testSweepBigqueryReservationReservation(region string) error {
	...
	listTemplate := strings.Split("https://bigqueryreservation.googleapis.com/v1/projects/{{project}}/locations/{{location}}/reservations", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://bigqueryreservation.googleapis.com/v1/projects/{{project}}/locations/{{location}}/reservations/{{name}}"
