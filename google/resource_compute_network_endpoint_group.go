...
you create the resource.`,
			...
			"network_endpoint_type": {
				...
				Optional:     true,
				ForceNew:     true,
				ValidateFunc: validation.StringInSlice([]string{"GCE_VM_IP", "GCE_VM_IP_PORT", ""}, false),
				Description:  `Type of network endpoints in this network endpoint group. Default value: "GCE_VM_IP_PORT" Possible values: ["GCE_VM_IP", "GCE_VM_IP_PORT"]`,
