...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionParameterManagerRegionalRegionalTemplate,
		DeleteFunction: testSweepParameterManagerRegionalRegionalTemplate,
	}
...
func testSweepParameterManagerRegionalRegionalTemplate(_ string) error {
	return listAndActionParameterManagerRegionalRegionalTemplate(deleteResourceParameterManagerRegionalRegionalTemplate)
}

func listAndActionParameterManagerRegionalRegionalTemplate(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ParameterManagerRegionalRegionalTemplate"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://parametermanager.{{location}}.rep.googleapis.com/v1/projects/{{project}}/locations/{{location}}/templates", "?")[0]
...
func deleteResourceParameterManagerRegionalRegionalTemplate(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://parametermanager.{{location}}.rep.googleapis.com/v1/projects/{{project}}/locations/{{location}}/templates/{{template_id}}"
