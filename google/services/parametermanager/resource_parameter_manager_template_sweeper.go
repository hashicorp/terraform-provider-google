...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_parameter_manager_template",
		ListAndAction:  listAndActionParameterManagerTemplate,
		DeleteFunction: testSweepParameterManagerTemplate,
	}
...
func testSweepParameterManagerTemplate(_ string) error {
	return listAndActionParameterManagerTemplate(deleteResourceParameterManagerTemplate)
}

func listAndActionParameterManagerTemplate(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ParameterManagerTemplate"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://parametermanager.googleapis.com/v1/projects/{{project}}/locations/global/templates", "?")[0]
...
func deleteResourceParameterManagerTemplate(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://parametermanager.googleapis.com/v1/projects/{{project}}/locations/global/templates/{{template_id}}"
