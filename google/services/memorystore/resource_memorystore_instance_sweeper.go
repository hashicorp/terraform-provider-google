...
func testSweepMemorystoreInstance(_ string) error {
	...
	for _, sub := range substitutions {
		...
		listTemplate := strings.Split("https://memorystore.googleapis.com/v1/projects/{{project}}/locations/{{location}}/instances", "?")[0]
		...
		for _, ri := range rl {
			...
			deleteTemplate := "https://memorystore.googleapis.com/v1/projects/{{project}}/locations/{{location}}/instances/{{instance_id}}"
