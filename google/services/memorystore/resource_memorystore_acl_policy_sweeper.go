...
func listAndActionMemorystoreAclPolicy(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://memorystore.googleapis.com/v1/projects/{{project}}/locations/{{location}}/aclPolicies", "?")[0]
...
func deleteResourceMemorystoreAclPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://memorystore.googleapis.com/v1/projects/{{project}}/locations/{{location}}/aclPolicies/{{acl_policy_id}}"
