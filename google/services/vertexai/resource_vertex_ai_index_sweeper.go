...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionVertexAIIndex,
		DeleteFunction: testSweepVertexAIIndex,
	}
...
func testSweepVertexAIIndex(_ string) error {
	return listAndActionVertexAIIndex(deleteResourceVertexAIIndex)
}

func listAndActionVertexAIIndex(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceVertexAIIndex(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
