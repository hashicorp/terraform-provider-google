...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionVertexAISchedule,
		DeleteFunction: testSweepVertexAISchedule,
	}
...
func testSweepVertexAISchedule(_ string) error {
	return listAndActionVertexAISchedule(deleteResourceVertexAISchedule)
}

func listAndActionVertexAISchedule(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://{{region}}-aiplatform.googleapis.com/v1/projects/{{project}}/locations/{{location}}/schedules", "?")[0]
...
func deleteResourceVertexAISchedule(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://{{region}}-aiplatform.googleapis.com/v1/projects/{{project}}/locations/{{location}}/schedules/{{name}}"
