...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionVertexAISemanticGovernancePolicyEngine,
		DeleteFunction: testSweepVertexAISemanticGovernancePolicyEngine,
	}
...
func testSweepVertexAISemanticGovernancePolicyEngine(_ string) error {
	return listAndActionVertexAISemanticGovernancePolicyEngine(deleteResourceVertexAISemanticGovernancePolicyEngine)
}

func listAndActionVertexAISemanticGovernancePolicyEngine(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "VertexAISemanticGovernancePolicyEngine"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://{{region}}-aiplatform.googleapis.com/v1/projects/{{project}}/locations/{{region}}/semanticGovernancePolicyEngine", "?")[0]
		...
		resourceList, ok := res["semanticGovernancePolicyEngines"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'semanticGovernancePolicyEngines'")
		} else {
...
func deleteResourceVertexAISemanticGovernancePolicyEngine(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://{{region}}-aiplatform.googleapis.com/v1/projects/{{project}}/locations/{{region}}/semanticGovernancePolicyEngine:deprovision"
