...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDataCatalogEntryGroup,
		DeleteFunction: testSweepDataCatalogEntryGroup,
	}
...
func testSweepDataCatalogEntryGroup(_ string) error {
	return listAndActionDataCatalogEntryGroup(deleteResourceDataCatalogEntryGroup)
}

func listAndActionDataCatalogEntryGroup(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceDataCatalogEntryGroup(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
