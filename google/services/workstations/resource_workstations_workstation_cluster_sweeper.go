...
func listAndActionWorkstationsWorkstationCluster(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://workstations.googleapis.com/v1/projects/{{project}}/locations/{{location}}/workstationClusters", "?")[0]
...
func deleteResourceWorkstationsWorkstationCluster(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://workstations.googleapis.com/v1/projects/{{project}}/locations/{{location}}/workstationClusters/{{workstation_cluster_id}}"
