...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionMonitoringService,
		DeleteFunction: testSweepMonitoringService,
	}
...
func testSweepMonitoringService(_ string) error {
	return listAndActionMonitoringService(deleteResourceMonitoringService)
}

func listAndActionMonitoringService(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceMonitoringService(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
