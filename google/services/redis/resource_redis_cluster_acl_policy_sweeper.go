...
func listAndActionRedisClusterAclPolicy(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://redis.googleapis.com/v1/projects/{{project}}/locations/{{location}}/aclPolicies", "?")[0]
...
func deleteResourceRedisClusterAclPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://redis.googleapis.com/v1/projects/{{project}}/locations/{{location}}/aclPolicies/{{acl_policy_id}}"
