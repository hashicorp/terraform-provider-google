...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionIAMBetaWorkloadIdentityPool,
		DeleteFunction: testSweepIAMBetaWorkloadIdentityPool,
	}
...
func testSweepIAMBetaWorkloadIdentityPool(_ string) error {
	return listAndActionIAMBetaWorkloadIdentityPool(deleteResourceIAMBetaWorkloadIdentityPool)
}

func listAndActionIAMBetaWorkloadIdentityPool(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'workloadIdentityPools'")
		} else {
...
func deleteResourceIAMBetaWorkloadIdentityPool(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
