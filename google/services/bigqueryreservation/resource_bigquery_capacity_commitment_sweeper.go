...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionBigqueryReservationCapacityCommitment,
		DeleteFunction: testSweepBigqueryReservationCapacityCommitment,
	}
...
func testSweepBigqueryReservationCapacityCommitment(_ string) error {
	return listAndActionBigqueryReservationCapacityCommitment(deleteResourceBigqueryReservationCapacityCommitment)
}

func listAndActionBigqueryReservationCapacityCommitment(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'capacityCommitments'")
		} else {
...
func deleteResourceBigqueryReservationCapacityCommitment(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
