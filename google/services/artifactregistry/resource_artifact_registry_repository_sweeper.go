...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionArtifactRegistryRepository,
		DeleteFunction: testSweepArtifactRegistryRepository,
	}
...
func testSweepArtifactRegistryRepository(_ string) error {
	return listAndActionArtifactRegistryRepository(deleteResourceArtifactRegistryRepository)
}

func listAndActionArtifactRegistryRepository(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[1]["region"] = "us"
...
func deleteResourceArtifactRegistryRepository(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
