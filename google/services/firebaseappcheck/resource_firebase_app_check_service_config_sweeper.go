...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionFirebaseAppCheckServiceConfig,
		DeleteFunction: testSweepFirebaseAppCheckServiceConfig,
	}
...
func testSweepFirebaseAppCheckServiceConfig(_ string) error {
	return listAndActionFirebaseAppCheckServiceConfig(deleteResourceFirebaseAppCheckServiceConfig)
}

func listAndActionFirebaseAppCheckServiceConfig(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "FirebaseAppCheckServiceConfig"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://firebaseappcheck.googleapis.com/v1/projects/{{project}}/services/", "?")[0]
...
func deleteResourceFirebaseAppCheckServiceConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://firebaseappcheck.googleapis.com/v1/projects/{{project}}/services/{{service_id}}?updateMask=enforcementMode"
