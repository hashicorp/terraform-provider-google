...
func listAndActionLicenseManagerConfiguration(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://licensemanager.googleapis.com/v1/projects/{{project}}/locations/{{location}}/configurations", "?")[0]
...
func deleteResourceLicenseManagerConfiguration(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://licensemanager.googleapis.com/v1/projects/{{project}}/locations/{{location}}/configurations/{{configuration_id}}"
