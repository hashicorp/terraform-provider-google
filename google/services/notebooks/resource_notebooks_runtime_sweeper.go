...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNotebooksRuntime,
		DeleteFunction: testSweepNotebooksRuntime,
	}
...
func testSweepNotebooksRuntime(_ string) error {
	return listAndActionNotebooksRuntime(deleteResourceNotebooksRuntime)
}

func listAndActionNotebooksRuntime(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceNotebooksRuntime(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
