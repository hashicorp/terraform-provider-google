...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionPubsubLiteReservation,
		DeleteFunction: testSweepPubsubLiteReservation,
	}
...
func testSweepPubsubLiteReservation(_ string) error {
	return listAndActionPubsubLiteReservation(deleteResourcePubsubLiteReservation)
}

func listAndActionPubsubLiteReservation(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'reservations'")
		} else {
...
func deleteResourcePubsubLiteReservation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
