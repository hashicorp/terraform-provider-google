...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesMulticastDomainGroup,
		DeleteFunction: testSweepNetworkServicesMulticastDomainGroup,
	}
...
func testSweepNetworkServicesMulticastDomainGroup(_ string) error {
	return listAndActionNetworkServicesMulticastDomainGroup(deleteResourceNetworkServicesMulticastDomainGroup)
}

func listAndActionNetworkServicesMulticastDomainGroup(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkServicesMulticastDomainGroup"
	...
	for _, mockConfig := range configs {
		...
		resourceList, ok := res["multicastDomainGroups"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'multicastDomainGroups'")
		} else {
...
func deleteResourceNetworkServicesMulticastDomainGroup(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
