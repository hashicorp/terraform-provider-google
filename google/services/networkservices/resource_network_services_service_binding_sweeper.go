...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesServiceBinding,
		DeleteFunction: testSweepNetworkServicesServiceBinding,
	}
...
func testSweepNetworkServicesServiceBinding(_ string) error {
	return listAndActionNetworkServicesServiceBinding(deleteResourceNetworkServicesServiceBinding)
}

func listAndActionNetworkServicesServiceBinding(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'serviceBindings'")
		} else {
...
func deleteResourceNetworkServicesServiceBinding(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
