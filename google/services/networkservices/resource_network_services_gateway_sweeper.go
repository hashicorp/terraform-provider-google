...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesGateway,
		DeleteFunction: testSweepNetworkServicesGateway,
	}
...
func testSweepNetworkServicesGateway(_ string) error {
	return listAndActionNetworkServicesGateway(deleteResourceNetworkServicesGateway)
}

func listAndActionNetworkServicesGateway(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceNetworkServicesGateway(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
