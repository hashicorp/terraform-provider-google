...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesEndpointPolicy,
		DeleteFunction: testSweepNetworkServicesEndpointPolicy,
	}
...
func testSweepNetworkServicesEndpointPolicy(_ string) error {
	return listAndActionNetworkServicesEndpointPolicy(deleteResourceNetworkServicesEndpointPolicy)
}

func listAndActionNetworkServicesEndpointPolicy(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'endpointPolicies'")
		} else {
...
func deleteResourceNetworkServicesEndpointPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
