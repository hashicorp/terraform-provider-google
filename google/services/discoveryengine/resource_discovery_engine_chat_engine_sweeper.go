...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDiscoveryEngineChatEngine,
		DeleteFunction: testSweepDiscoveryEngineChatEngine,
	}
...
func testSweepDiscoveryEngineChatEngine(_ string) error {
	return listAndActionDiscoveryEngineChatEngine(deleteResourceDiscoveryEngineChatEngine)
}

func listAndActionDiscoveryEngineChatEngine(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "DiscoveryEngineChatEngine"
	...
	intermediateValues[0]["collection_id"] = "default_collection"
	intermediateValues[0]["region"] = "global"
	intermediateValues[1] = map[string]string{}
	intermediateValues[1]["collection_id"] = "default_collection"
...
func deleteResourceDiscoveryEngineChatEngine(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://{{location}}-discoveryengine.googleapis.com/v1/projects/{{project}}/locations/{{location}}/collections/{{collection_id}}/engines/{{engine_id}}"
