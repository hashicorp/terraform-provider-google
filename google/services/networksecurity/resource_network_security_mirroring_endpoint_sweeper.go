...
func listAndActionNetworkSecurityMirroringEndpoint(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networksecurity.googleapis.com/v1/projects/{{project}}/locations/{{location}}/mirroringEndpoints", "?")[0]
...
func deleteResourceNetworkSecurityMirroringEndpoint(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networksecurity.googleapis.com/v1/projects/{{project}}/locations/{{location}}/mirroringEndpoints/{{mirroring_endpoint_id}}"
