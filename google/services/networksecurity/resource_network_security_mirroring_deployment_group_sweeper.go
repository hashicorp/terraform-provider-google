...
func testSweepNetworkSecurityMirroringDeploymentGroup(_ string) error {
	...
	for _, sub := range substitutions {
		...
		listTemplate := strings.Split("https://networksecurity.googleapis.com/v1/projects/{{project}}/locations/{{location}}/mirroringDeploymentGroups", "?")[0]
		...
		for _, ri := range rl {
			...
			deleteTemplate := "https://networksecurity.googleapis.com/v1/projects/{{project}}/locations/{{location}}/mirroringDeploymentGroups/{{mirroring_deployment_group_id}}"
