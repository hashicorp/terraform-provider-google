...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkSecurityFirewallEndpointAssociation,
		DeleteFunction: testSweepNetworkSecurityFirewallEndpointAssociation,
	}
...
func testSweepNetworkSecurityFirewallEndpointAssociation(_ string) error {
	return listAndActionNetworkSecurityFirewallEndpointAssociation(deleteResourceNetworkSecurityFirewallEndpointAssociation)
}

func listAndActionNetworkSecurityFirewallEndpointAssociation(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkSecurityFirewallEndpointAssociation"
	...
	intermediateValues[0]["parent"] = "projects/" + envvar.GetTestProjectFromEnv()
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networksecurity.googleapis.com/v1/{{parent}}/locations/{{location}}/firewallEndpointAssociations", "?")[0]
		...
		resourceList, ok := res["firewallEndpointAssociations"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'firewallEndpointAssociations'")
		} else {
...
func deleteResourceNetworkSecurityFirewallEndpointAssociation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networksecurity.googleapis.com/v1/{{parent}}/locations/{{location}}/firewallEndpointAssociations/{{name}}"
