...
func testSweepNetworkSecurityMirroringDeployment(_ string) error {
	...
	for _, sub := range substitutions {
		...
		listTemplate := strings.Split("https://networksecurity.googleapis.com/v1/projects/{{project}}/locations/{{location}}/mirroringDeployments", "?")[0]
		...
		for _, ri := range rl {
			...
			deleteTemplate := "https://networksecurity.googleapis.com/v1/projects/{{project}}/locations/{{location}}/mirroringDeployments/{{mirroring_deployment_id}}"
