...
func testSweepGKEHub2Fleet(_ string) error {
	...
	for _, sub := range substitutions {
		...
		listTemplate := strings.Split("https://gkehub.googleapis.com/v1/projects/{{project}}/locations/global/fleets", "?")[0]
		...
		for _, ri := range rl {
			...
			deleteTemplate := "https://gkehub.googleapis.com/v1/projects/{{project}}/locations/global/fleets/default"
