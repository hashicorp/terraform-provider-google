...
func listAndActionGKEHub2Scope(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://gkehub.googleapis.com/v1/projects/{{project}}/locations/global/scopes", "?")[0]
...
func deleteResourceGKEHub2Scope(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://gkehub.googleapis.com/v1/projects/{{project}}/locations/global/scopes/{{scope_id}}"
