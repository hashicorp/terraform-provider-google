...
func listAndActionGKEHub2RolloutSequence(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://gkehub.googleapis.com/v1/projects/{{project}}/locations/global/rolloutSequences", "?")[0]
...
func deleteResourceGKEHub2RolloutSequence(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://gkehub.googleapis.com/v1/projects/{{project}}/locations/global/rolloutSequences/{{rollout_sequence_id}}"
