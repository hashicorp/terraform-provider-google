...
func init() {
	sweeper.AddTestSweepers("IAMWorkforcePoolWorkforcePoolProvider", testSweepIAMWorkforcePoolWorkforcePoolProvider)
}

func testSweepIAMWorkforcePoolWorkforcePoolProvider(_ string) error {
