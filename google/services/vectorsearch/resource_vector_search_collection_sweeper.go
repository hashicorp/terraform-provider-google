...
func listAndActionVectorSearchCollection(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://vectorsearch.googleapis.com/v1/projects/{{project}}/locations/{{location}}/collections", "?")[0]
...
func deleteResourceVectorSearchCollection(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://vectorsearch.googleapis.com/v1/projects/{{project}}/locations/{{location}}/collections/{{collection_id}}"
