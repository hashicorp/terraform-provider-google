...
func listAndActionOSConfigV2PolicyOrchestrator(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://osconfig.googleapis.com/v2/projects/{{project}}/locations/global/policyOrchestrators", "?")[0]
...
func deleteResourceOSConfigV2PolicyOrchestrator(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://osconfig.googleapis.com/v2/projects/{{project}}/locations/global/policyOrchestrators/{{policy_orchestrator_id}}"
