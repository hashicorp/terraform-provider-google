...
func TestAccIdentityPlatformTenantListQuery_generated(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccIdentityPlatformTenant_identityPlatformTenantBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_identity_platform_tenant.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_identity_platform_tenant.list_query",
...
func testAccIdentityPlatformTenant_identityPlatformTenantBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_identity_platform_tenant" "list_query" {
    provider = google
	limit = 10000
    config {
    }
