...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeHttpHealthCheck,
		DeleteFunction: testSweepComputeHttpHealthCheck,
	}
...
func testSweepComputeHttpHealthCheck(_ string) error {
	return listAndActionComputeHttpHealthCheck(deleteResourceComputeHttpHealthCheck)
}

func listAndActionComputeHttpHealthCheck(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeHttpHealthCheck(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
