...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeImage,
		DeleteFunction: testSweepComputeImage,
	}
...
func testSweepComputeImage(_ string) error {
	return listAndActionComputeImage(deleteResourceComputeImage)
}

func listAndActionComputeImage(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeImage(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
