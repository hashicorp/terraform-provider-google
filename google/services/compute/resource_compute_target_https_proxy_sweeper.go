...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeTargetHttpsProxy,
		DeleteFunction: testSweepComputeTargetHttpsProxy,
	}
...
func testSweepComputeTargetHttpsProxy(_ string) error {
	return listAndActionComputeTargetHttpsProxy(deleteResourceComputeTargetHttpsProxy)
}

func listAndActionComputeTargetHttpsProxy(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeTargetHttpsProxy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
