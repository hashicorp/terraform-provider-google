...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionBackendBucket,
		DeleteFunction: testSweepComputeRegionBackendBucket,
	}
...
func testSweepComputeRegionBackendBucket(_ string) error {
	return listAndActionComputeRegionBackendBucket(deleteResourceComputeRegionBackendBucket)
}

func listAndActionComputeRegionBackendBucket(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeRegionBackendBucket"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/backendBuckets", "?")[0]
...
func deleteResourceComputeRegionBackendBucket(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/backendBuckets/{{name}}"
