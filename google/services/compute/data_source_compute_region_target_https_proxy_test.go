...
func TestAccDataSourceComputeRegionTargetHttpsProxy_basic(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeRegionTargetHttpsProxy_regionTargetHttpsProxyBasicExampleDataSource(context),
...
func testAccComputeRegionTargetHttpsProxy_regionTargetHttpsProxyBasicExampleDataSource(context map[string]interface{}) string {
