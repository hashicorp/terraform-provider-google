...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionBackendService,
		DeleteFunction: testSweepComputeRegionBackendService,
	}
...
func testSweepComputeRegionBackendService(_ string) error {
	return listAndActionComputeRegionBackendService(deleteResourceComputeRegionBackendService)
}

func listAndActionComputeRegionBackendService(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[2]["region"] = "europe-west4"
...
func deleteResourceComputeRegionBackendService(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
