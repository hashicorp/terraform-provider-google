...
func listAndActionComputeZoneVmExtensionPolicy(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/v1/projects/{{project}}/aggregated/vmExtensionPolicies", "?")[0]
...
func deleteResourceComputeZoneVmExtensionPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/v1/projects/{{project}}/zones/{{zone}}/vmExtensionPolicies/{{name}}"
	if obj["zone"] == nil {
