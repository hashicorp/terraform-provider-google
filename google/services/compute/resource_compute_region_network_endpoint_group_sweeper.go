...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionNetworkEndpointGroup,
		DeleteFunction: testSweepComputeRegionNetworkEndpointGroup,
	}
...
func testSweepComputeRegionNetworkEndpointGroup(_ string) error {
	return listAndActionComputeRegionNetworkEndpointGroup(deleteResourceComputeRegionNetworkEndpointGroup)
}

func listAndActionComputeRegionNetworkEndpointGroup(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[2]["region"] = "asia-northeast3"
...
func deleteResourceComputeRegionNetworkEndpointGroup(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
