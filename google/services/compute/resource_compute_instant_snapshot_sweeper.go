...
func testSweepComputeInstantSnapshot(_ string) error {
	...
	for _, sub := range substitutions {
		...
		listTemplate := strings.Split("https://compute.googleapis.com/compute/v1/projects/{{project}}/aggregated/instantSnapshots", "?")[0]
		...
		for _, ri := range rl {
			...
			deleteTemplate := "https://compute.googleapis.com/compute/v1/projects/{{project}}/zones/{{zone}}/instantSnapshots/{{name}}"
			if obj["zone"] == nil {
