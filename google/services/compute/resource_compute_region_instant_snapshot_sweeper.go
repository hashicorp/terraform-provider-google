...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionInstantSnapshot,
		DeleteFunction: testSweepComputeRegionInstantSnapshot,
	}
...
func testSweepComputeRegionInstantSnapshot(_ string) error {
	return listAndActionComputeRegionInstantSnapshot(deleteResourceComputeRegionInstantSnapshot)
}

func listAndActionComputeRegionInstantSnapshot(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeRegionInstantSnapshot"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/instantSnapshots", "?")[0]
...
func deleteResourceComputeRegionInstantSnapshot(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/instantSnapshots/{{name}}"
