...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionSecurityCenterV2ProjectMuteConfig,
		DeleteFunction: testSweepSecurityCenterV2ProjectMuteConfig,
	}
...
func testSweepSecurityCenterV2ProjectMuteConfig(_ string) error {
	return listAndActionSecurityCenterV2ProjectMuteConfig(deleteResourceSecurityCenterV2ProjectMuteConfig)
}

func listAndActionSecurityCenterV2ProjectMuteConfig(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://securitycenter.googleapis.com/v2/projects/{{project}}/locations/{{location}}/muteConfigs", "?")[0]
...
func deleteResourceSecurityCenterV2ProjectMuteConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://securitycenter.googleapis.com/v2/projects/{{project}}/locations/{{location}}/muteConfigs/{{mute_config_id}}"
