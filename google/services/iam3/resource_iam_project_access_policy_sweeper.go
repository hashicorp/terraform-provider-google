...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionIAM3ProjectAccessPolicy,
		DeleteFunction: testSweepIAM3ProjectAccessPolicy,
	}
...
func testSweepIAM3ProjectAccessPolicy(_ string) error {
	return listAndActionIAM3ProjectAccessPolicy(deleteResourceIAM3ProjectAccessPolicy)
}

func listAndActionIAM3ProjectAccessPolicy(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "IAM3ProjectAccessPolicy"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://iam.googleapis.com/v3/projects/{{project}}/locations/{{location}}/accessPolicies", "?")[0]
		...
		resourceList, ok := res["accessPolicies"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'accessPolicies'")
		} else {
...
func deleteResourceIAM3ProjectAccessPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://iam.googleapis.com/v3/projects/{{project}}/locations/{{location}}/accessPolicies/{{access_policy_id}}"
