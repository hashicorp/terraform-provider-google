...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDatabaseMigrationServiceConnectionProfile,
		DeleteFunction: testSweepDatabaseMigrationServiceConnectionProfile,
	}
...
func testSweepDatabaseMigrationServiceConnectionProfile(_ string) error {
	return listAndActionDatabaseMigrationServiceConnectionProfile(deleteResourceDatabaseMigrationServiceConnectionProfile)
}

func listAndActionDatabaseMigrationServiceConnectionProfile(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceDatabaseMigrationServiceConnectionProfile(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
