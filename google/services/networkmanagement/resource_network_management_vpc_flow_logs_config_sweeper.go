...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkManagementVpcFlowLogsConfig,
		DeleteFunction: testSweepNetworkManagementVpcFlowLogsConfig,
	}
...
func testSweepNetworkManagementVpcFlowLogsConfig(_ string) error {
	return listAndActionNetworkManagementVpcFlowLogsConfig(deleteResourceNetworkManagementVpcFlowLogsConfig)
}

func listAndActionNetworkManagementVpcFlowLogsConfig(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkmanagement.googleapis.com/v1/projects/{{project}}/locations/{{location}}/vpcFlowLogsConfigs", "?")[0]
...
func deleteResourceNetworkManagementVpcFlowLogsConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkmanagement.googleapis.com/v1/projects/{{project}}/locations/{{location}}/vpcFlowLogsConfigs/{{vpc_flow_logs_config_id}}"
