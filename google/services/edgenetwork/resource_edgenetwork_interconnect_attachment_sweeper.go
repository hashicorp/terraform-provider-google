...
func init() {
	sweeper.AddTestSweepers("EdgenetworkInterconnectAttachment", testSweepEdgenetworkInterconnectAttachment)
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepEdgenetworkInterconnectAttachment(region string) error {
	resourceName := "EdgenetworkInterconnectAttachment"
	...
	listTemplate := strings.Split("https://edgenetwork.googleapis.com/v1/projects/{{project}}/locations/{{location}}/aggregated/interconnectAttachments", "?")[0]
	...
	resourceList, ok := res["interconnectAttachments"]
	if !ok {
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://edgenetwork.googleapis.com/v1/projects/{{project}}/locations/{{location}}/zones/{{zone}}/interconnectAttachments/{{interconnect_attachment_id}}"
		if obj["zone"] == nil {
