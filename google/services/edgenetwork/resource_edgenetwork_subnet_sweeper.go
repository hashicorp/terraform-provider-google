...
func init() {
	sweeper.AddTestSweepers("EdgenetworkSubnet", testSweepEdgenetworkSubnet)
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepEdgenetworkSubnet(region string) error {
	resourceName := "EdgenetworkSubnet"
	...
	listTemplate := strings.Split("https://edgenetwork.googleapis.com/v1/projects/{{project}}/locations/{{location}}/aggregated/subnets", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://edgenetwork.googleapis.com/v1/projects/{{project}}/locations/{{location}}/zones/{{zone}}/subnets/{{subnet_id}}"
		if obj["zone"] == nil {
