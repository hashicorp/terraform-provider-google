...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCloudAssetProjectFeed,
		DeleteFunction: testSweepCloudAssetProjectFeed,
	}
...
func testSweepCloudAssetProjectFeed(_ string) error {
	return listAndActionCloudAssetProjectFeed(deleteResourceCloudAssetProjectFeed)
}

func listAndActionCloudAssetProjectFeed(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'feeds'")
		} else {
...
func deleteResourceCloudAssetProjectFeed(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
