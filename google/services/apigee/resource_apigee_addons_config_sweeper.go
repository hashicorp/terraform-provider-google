...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionApigeeAddonsConfig,
		DeleteFunction: testSweepApigeeAddonsConfig,
	}
...
func testSweepApigeeAddonsConfig(_ string) error {
	return listAndActionApigeeAddonsConfig(deleteResourceApigeeAddonsConfig)
}

func listAndActionApigeeAddonsConfig(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceApigeeAddonsConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
