...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionParallelstoreInstance,
		DeleteFunction: testSweepParallelstoreInstance,
	}
...
func testSweepParallelstoreInstance(_ string) error {
	return listAndActionParallelstoreInstance(deleteResourceParallelstoreInstance)
}

func listAndActionParallelstoreInstance(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ParallelstoreInstance"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://parallelstore.googleapis.com/v1/projects/{{project}}/locations/{{location}}/instances", "?")[0]
...
func deleteResourceParallelstoreInstance(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://parallelstore.googleapis.com/v1/projects/{{project}}/locations/{{location}}/instances/{{instance_id}}"
