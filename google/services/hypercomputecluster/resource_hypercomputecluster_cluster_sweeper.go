...
func listAndActionHypercomputeclusterCluster(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://hypercomputecluster.googleapis.com/v1/projects/{{project}}/locations/{{location}}/clusters", "?")[0]
...
func deleteResourceHypercomputeclusterCluster(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://hypercomputecluster.googleapis.com/v1/projects/{{project}}/locations/{{location}}/clusters/{{cluster_id}}"
