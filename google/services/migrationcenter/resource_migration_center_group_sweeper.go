...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionMigrationCenterGroup,
		DeleteFunction: testSweepMigrationCenterGroup,
	}
...
func testSweepMigrationCenterGroup(_ string) error {
	return listAndActionMigrationCenterGroup(deleteResourceMigrationCenterGroup)
}

func listAndActionMigrationCenterGroup(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "MigrationCenterGroup"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://migrationcenter.googleapis.com/v1/projects/{{project}}/locations/{{location}}/groups", "?")[0]
...
func deleteResourceMigrationCenterGroup(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://migrationcenter.googleapis.com/v1/projects/{{project}}/locations/{{location}}/groups/{{group_id}}"
