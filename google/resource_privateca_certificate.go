...
func resourcePrivatecaCertificateUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("pem_csr"); !isEmptyValue(reflect.ValueOf(v)) && (ok || !reflect.DeepEqual(v, pemCsrProp)) {
		obj["pemCsr"] = pemCsrProp
	}
	...
	if d.HasChange("pem_csr") {
		updateMask = append(updateMask, "pemCsr")
	}
