...
DNS managed zones can be imported using either of these accepted formats:

```

```
$ terraform import google_dns_managed_zone.zone-name {{project}}/{{name}}
$ terraform import google_dns_managed_zone.zone-name {{name}}
```
