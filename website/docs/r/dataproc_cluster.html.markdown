...
* `graceful_decommission_timeout` - (Optional) Allows graceful decommissioning when you change the number of worker nodes directly through a terraform apply.
      Does not affect auto scaling decommissioning from an autoscaling policy.
