...
* `web` - (Required) The web name or id to bind to attach IAM policy to.
...
$ terraform import google_iap_web_iam_binding.editor "projects/{{project}}/iap_web roles/editor"

$ terraform import google_iap_web_iam_member.editor "projects/{{project}}/iap_web roles/editor jane@example.com"
```
