...
* `allowed_service_patterns` -
  ...
  Structure is [documented below](#nested_service_perimeters_status_vpc_accessible_services_allowed_service_patterns).
...
<a name="nested_service_perimeters_status_vpc_accessible_services_allowed_service_patterns"></a>The `allowed_service_patterns` block supports:
...
* `modifiers` -
  ...
  Structure is [documented below](#nested_service_perimeters_status_vpc_accessible_services_allowed_service_patterns_modifiers).


<a name="nested_service_perimeters_status_vpc_accessible_services_allowed_service_patterns_modifiers"></a>The `modifiers` block supports:

* `add_request_header` -
  (Optional)
  Adds additional HTTP request headers.
  Structure is [documented below](#nested_service_perimeters_status_vpc_accessible_services_allowed_service_patterns_modifiers_add_request_header).


<a name="nested_service_perimeters_status_vpc_accessible_services_allowed_service_patterns_modifiers_add_request_header"></a>The `add_request_header` block supports:
...
* `allowed_service_patterns` -
  ...
  Specifies which Google services are allowed to be accessed from
  VPC networks in the service perimeter.
  Structure is [documented below](#nested_service_perimeters_spec_vpc_accessible_services_allowed_service_patterns).
...
<a name="nested_service_perimeters_spec_vpc_accessible_services_allowed_service_patterns"></a>The `allowed_service_patterns` block supports:
...
* `modifiers` -
  (Optional)
  Modifiers to apply to the requests that match the URL pattern.
  Structure is [documented below](#nested_service_perimeters_spec_vpc_accessible_services_allowed_service_patterns_modifiers).


<a name="nested_service_perimeters_spec_vpc_accessible_services_allowed_service_patterns_modifiers"></a>The `modifiers` block supports:

* `add_request_header` -
  (Optional)
  Adds additional HTTP request headers.
  Structure is [documented below](#nested_service_perimeters_spec_vpc_accessible_services_allowed_service_patterns_modifiers_add_request_header).


<a name="nested_service_perimeters_spec_vpc_accessible_services_allowed_service_patterns_modifiers_add_request_header"></a>The `add_request_header` block supports:
