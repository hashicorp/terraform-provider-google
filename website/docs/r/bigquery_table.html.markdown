...
* `require_partition_filter` - (Optional) If enabled, queries over this table
    require a partition filter that can be used for partition elimination to be specified.
