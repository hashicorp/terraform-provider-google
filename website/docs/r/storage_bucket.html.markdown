...
* `response_header` - (Optional) The list of HTTP headers other than the [CORS safelisted response headers](https://fetch.spec.whatwg.org/#cors-safelisted-response-header-name) to give permission for the user-agent to share across domains.
