...
description: |-
  List Network Services multicastdomain resources in a project for use with terraform query
  and .tfquery.hcl files.
---

# google_network_services_multicast_domain (list)

Lists [`google_network_services_multicast_domain`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/google_network_services_multicast_domain) resources for use with [`terraform query`](https://developer.hashicorp.com/terraform/cli/commands/query) and **`.tfquery.hcl`** files.
...
```hcl
list "google_network_services_multicast_domain" "all" {
  provider = google
...
By default each result includes **resource identity** for [`google_network_services_multicast_domain`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/google_network_services_multicast_domain) (see [Resource identity](https://developer.hashicorp.com/terraform/language/block/import#identity)).

With `include_resource = true` on the `list` block, results also include the full resource-style attributes documented for the managed [`google_network_services_multicast_domain` resource](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/google_network_services_multicast_domain#attributes-reference).
