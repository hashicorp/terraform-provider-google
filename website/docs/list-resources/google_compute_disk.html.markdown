...
description: |-
  List Compute Engine disk resources in a project for use with terraform query
...
By default each result includes **resource identity** for [`google_compute_disk`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/google_compute_disk) (see [Resource identity](https://developer.hashicorp.com/terraform/language/resources/identities)).
